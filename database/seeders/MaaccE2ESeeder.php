 ...
 *
 * Pair it with `MAACC_LLM_DRIVER=fake` (the {@see DeterministicLlmRouter})
 * to drive a complete run without any external model provider.
 */
class MaaccE2ESeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $application = Application::updateOrCreate(['slug' => self::APP_SLUG], [
            ...
            'description' => 'Deterministic application used by the MAACC end-to-end validation harness.',
    ...
    private function seedCredential(Application $application, User $user): void
    {
        ...
        $this->command->info('MAACC E2E credential provisioned for the SDK smoke:');
