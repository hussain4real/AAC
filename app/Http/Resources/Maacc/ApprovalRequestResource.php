 ...
 * (resources/js/maacc/data.ts `ApprovalItem`), plus the queue bucket key,
    ...
    private function modelDetails(LlmProvider $model): array
    {
        return [
            ...
            'fields' => [
                ...
                ['k' => 'Input cost', 'v' => $model->pricing_currency.' '.$model->input_cost.' / 1M tokens'],
                ['k' => 'Output cost', 'v' => $model->pricing_currency.' '.$model->output_cost.' / 1M tokens'],
                ['k' => 'Pricing source', 'v' => $model->pricing_source],
                ['k' => 'Pricing version', 'v' => $model->pricing_version],
