...
/**
 * Validates a MAACC platform-role grant (Phase 8B). The route already requires
...
class StorePlatformAccessRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'ttl_minutes' => ['nullable', 'integer', 'min:1', 'max:'.(int) config('maacc.platform.break_glass.max_ttl_minutes', 240)],
        ];
    }
}
