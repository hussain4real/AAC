...
test('the knowledge console page renders', function () {
    ...
    $this->withoutVite()
        ...
        ->assertOk()
        ->assertInertia(fn (Assert $page) => $page->component('maacc/knowledge'));
});
...
test('the knowledge page exposes sources with their documents', function () {
    ...
    $this->actingAs($owner)
        ...
        ->assertInertia(fn (Assert $page) => $page
            ...
            ->where('maacc.knowledgeSources.0.name', 'Ops Manual')
            ->where('maacc.knowledgeSources.0.documentCount', 1)
            ->where('maacc.knowledgeSources.0.documents.0.title', 'Doc A'));
});
