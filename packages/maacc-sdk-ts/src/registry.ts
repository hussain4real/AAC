...
/** The context handed to a tool handler when MAACC pauses a run for it. */
 ...
 * own business logic and data access live; MAACC sees only the returned result,
...
export class ToolHandlerRegistry {
   ...
   * MAACC's SDK Implementation Center (defaults to the function name).
   */
