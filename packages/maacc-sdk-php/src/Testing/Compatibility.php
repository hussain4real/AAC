...
/**
 * The client-side mirror of MAACC's tool-implementation compatibility rule. Given
 * the version + schema fingerprint a contract currently carries (from the
 * manifest) and what the application built against, it predicts the status MAACC
