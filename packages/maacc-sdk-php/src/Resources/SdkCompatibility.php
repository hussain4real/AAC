 ...
 * instance, returned by {@see MaaccClient::compatibility()}. It answers
 * the headline question — "can my installed package talk to this MAACC?" — and
...
final class SdkCompatibility
{
    ...
    /**
     * Whether the installed client can safely talk to this MAACC instance.
     */
    ...
    /**
     * Whether the installed client is below MAACC's supported minimum and must be
