 ...
 * MAACC's `/oauth/token` endpoint (the client_credentials grant), caching it in
...
final class TokenProvider
{
     ...
     * from a token that MAACC rejected mid-flight.
     */
     ...
     *
     * @throws MaaccApiException when MAACC rejects the credential
     */
