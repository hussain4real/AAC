/* ============================================================
   ...
   to the Milaha tokens in app.css (.maacc-theme). Interactive
...
import { execModeLabel } from '@/maacc/data';
...
> = {
    hosted: { label: 'MAACC-hosted', tone: 'purple', icon: 'server' },
...
export function Card({
    ...
    return (
        <div
            onClick={onClick}
            className={className + (hover ? ' maacc-card-hover' : '')}
            style={{
                background: 'var(--surface)',
                ...
                >
                    {breadcrumb.map((b, i) => (
                        ...
                        >
                            ...
                            <span
                                onClick={b.onClick}
                                className={b.onClick ? 'maacc-link' : ''}
                                style={{
        ...
        <div style={{ position: 'relative', ...style }}>
            <ShadSelect value={value} onValueChange={onChange}>
                ...
                <SelectContent
                    ...
                    // `.maacc-theme` scope — re-apply it (as Modal does) so the
    ...
    return (
        <Dialog open={open} onOpenChange={(o) => !o && onClose()}>
            <DialogContent
                ...
                className="maacc-theme top-[7vh] translate-y-0 grid-cols-1 gap-0 overflow-hidden border p-0"
                style={{
                    width,
