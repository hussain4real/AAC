...
export type Agent = {
     ...
     * plus the tool brief MAACC auto-generates from the agent's tools. Falls back
...
const tools: Tool[] = [
    ...
    },
    {
        ...
        desc: 'Summarizes an uploaded document passed inline to MAACC.',
        timeout: '20s',
        maxPayload: '1 MB',
...
const policies: Policy[] = [
    {
        ...
        on: true,
        desc: 'MAACC must never hold credentials for or directly query application production databases.',
    },
    {
...
export type MaaccData = typeof MAACC;
