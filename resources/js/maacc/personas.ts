/* ============================================================
   MAACC — Personas, role-based nav, and scope computation
...
import type { MaaccDataset } from './use-data';
...
/**
 * A nav item. `permission`, when set, is a MAACC platform permission
...
export function computeScope(persona: Persona, data: MaaccDataset): Scope {
