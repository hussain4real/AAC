/* ============================================================
   MAACC — Knowledge Sources (Phase 6F)
...
} from '@/actions/App/Http/Controllers/Maacc/KnowledgeDocumentController';
import {
    destroy as destroySource,
    reindex as reindexSource,
    store as storeSource,
    update as updateSource,
} from '@/actions/App/Http/Controllers/Maacc/KnowledgeSourceController';
import {
    Badge,
    Btn,
    Card,
...
function SourceFormModal({
    ...
    return (
        <Modal
            ...
            sub="MAACC indexes and retrieves from this approved document collection on behalf of a knowledge-retrieval tool."
            width={600}
            footer={
                <>
...
export default function Knowledge() {
    ...
    const { currentTeam } = usePage().props;
    const teamSlug = currentTeam?.slug ?? '';
    const sources = MAACC.knowledgeSources;
    ...
    const toggleStatus = (source: MaaccKnowledgeSource) => {
        router.put(
    ...
    const remove = (source: MaaccKnowledgeSource) => {
        ...
        <>
            ...
            <div className="route-anim">
                <PageHeader
                    ...
                    sub="Register governed document collections for retrieval-augmented agents. MAACC indexes each source and a knowledge-retrieval tool retrieves cited passages from it — with the same schema, sensitivity, approval, and audit standards as every other tool."
                    actions={
