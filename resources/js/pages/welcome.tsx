...
const ICON_PATHS = {
    ...
    shieldCheck:
        'M12 3 4 6v6c0 4.5 3.3 7.6 8 9 4.7-1.4 8-4.5 8-9V6l-8-3Zm-3 9 2 2 4-4',
    ...
    terminal:
        'M4 5h16a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1Zm3 4 3 3-3 3m6 0h4',
    ...
    fingerprint:
        'M12 10a2 2 0 0 1 2 2c0 3-.5 5-1.5 7M8 14c.5-3 .3-5 4-5M5 12a7 7 0 0 1 11-5.7M12 3a9 9 0 0 0-6.3 15.4',
};
function Icon({
    name,
    size = 18,
...
function useThemeState() {
    const [theme, setTheme] = useState(() => {
        try {
            return localStorage.getItem('maacc-landing-theme') || 'dark';
        } catch (e) {
            return 'dark';
        }
    });
    useEffect(() => {
        ...
        try {
            localStorage.setItem('maacc-landing-theme', theme);
        } catch (e) {}
    }, [theme]);
        ...
        >
            ...
            <span
                style={{
                    ...
                    color: copied ? 'var(--teal-500)' : 'var(--text-3)',
                    transition: 'color .2s',
                }}
            >
...
function SectionHead({ kicker, title, sub, center, children }) {
    return (
        ...
        >
            {kicker && (
                <Reveal as="div" className="ls-kicker">
                    {kicker}
                </Reveal>
            )}
            {title && (
    ...
    stats: [
        {
            ...
            sub: 'across connected apps',
        },
        {
            end: 280,
            suffix: 'ms',
            label: 'median orchestration overhead',
            sub: 'excl. model + tool time',
        },
        {
            end: 99.98,
            decimals: 2,
        ...
        },
        {
            ...
            label: 'tool execution modes',
            sub: 'one contract, any runtime',
        },
    ],
    logos: [
        'Marine Operations',
...
function NodeField({ density = 1, speed = 1, style = {}, interactive = true }) {
    ...
    useEffect(() => {
        ...
        const palette = () => {
            ...
            return dark
                ? {
                      node: 'rgba(176,124,216,0.9)',
                      node2: 'rgba(76,208,189,0.85)',
                      line: '140,110,200',
                      hot: '124,211,197',
                      dot: 'rgba(150,180,240,0.5)',
                  }
                : {
                      node: 'rgba(92,15,140,0.75)',
                      node2: 'rgba(15,155,131,0.7)',
                      line: '92,15,140',
                      hot: '15,155,131',
                      dot: 'rgba(20,27,43,0.4)',
                  };
        };
        let col = palette();
        ...
        step();
        if (reduce) {
            /* one static frame drawn already */
        }
    ...
    return (
        <div
            style={{
                ...
                justifyContent: 'center',
                boxShadow:
                    '0 2px 10px rgba(60,10,90,.4), inset 0 1px 0 rgba(255,255,255,.16)',
            }}
        >
            <svg
                width={size * 0.62}
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <Btn href="/login" variant="ghost" style={{ flex: 1 }}>
                        Log in
                    </Btn>
                    <ThemeToggle />
                </div>
...
function HeroConsole() {
    ...
    useEffect(() => {
        ...
        const t2 = setInterval(() => {
            ...
            setMs(() => 280 + Math.floor(Math.random() * 70));
        }, 1500);
        return () => {
            clearInterval(t);
            clearInterval(t2);
            ...
            >
                ...
                <span
                    ...
                    style={{
                        ...
                        borderColor: 'var(--primary-soft-2)',
                    }}
                >
                    <span
                        style={{
                ...
                >
                    ...
                    >
                        ...
                        {(step.k === 'tool' || step.k === 'wait') && (
                            ...
                            >
                                <Icon name="link" size={13} /> client-side tool
                                → getOperationalRecords() runs in your app
                            </div>
                        )}
                    </div>
                    {feed.map((f, i) => (
        ...
        >
            <div
                style={{
                    ...
                    inset: 0,
                    background:
                        'linear-gradient(180deg, var(--hero-1), var(--hero-2) 55%, var(--bg))',
                }}
            />
            <div className="ls-gridbg" style={{ opacity: 0.9 }} />
            ...
            >
                ...
                >
                    <Reveal as="div">
                        <span className="ls-eyebrow">
                            <span className="dot" /> Multi AI Agent Control
                            Centre
                        </span>
                    </Reveal>
                    <Reveal
                    ...
                    >
                        One <span className="ls-grad">control centre</span> for
                        every AI agent.
                    </Reveal>
                    <Reveal
                        as="p"
                    ...
                    >
                        Create, govern and ship AI agents from a single
                        platform. MAACC orchestrates models, tools and runs
                        behind one secure API — while your data and business
                        logic never leave your app.
                    </Reveal>
                    <Reveal
                        as="div"
                        delay={3}
                    ...
                    >
                        ...
                        <Btn href="#docs" variant="glass" icon="book">
                            Read the docs
                        </Btn>
                    </Reveal>
                    <Reveal
                    ...
                    <Reveal as="div" delay={5} style={{ marginTop: 40 }}>
                        ...
                        >
                            Orchestrates your approved model catalog
                        </div>
                        <div
                            style={{
                                display: 'flex',
                ...
                <Reveal
                    as="div"
                    delay={4}
                    style={{ maxWidth: 760, margin: '56px auto 0' }}
                >
                    <HeroConsole />
                </Reveal>
            </div>
        ...
        >
            ...
            >
                    ...
                    <defs>
                        {Object.keys(PATHS).map((k) => (
                            ...
                            >
                                <path
                                    d="M0,0 L6,3 L0,6 Z"
                                    fill={PATH_META[k].color}
                                    opacity={activePaths.has(k) ? 1 : 0.5}
                                />
                            </marker>
                        ))}
                    </defs>
                        ...
                        return (
                            <g key={k}>
                                ...
                                <path
                                    ...
                                    id={`p-${k}`}
                                    fill="none"
                                    stroke={PATH_META[k].color}
                                    strokeWidth={on ? 2.4 : 1.4}
                                    strokeOpacity={on ? 0.95 : 0.32}
                                    strokeDasharray="7 7"
                                    markerEnd={`url(#ar--${k})`}
                                    style={{
                                        animation: `dashFlow ${on ? 1 : 2.4}s linear infinite`,
                                        transition:
                                            'stroke-width .3s, stroke-opacity .3s',
                                    }}
                                />
                                {/* traveling packet */}
                                <circle
                ...
                <div
                    className="ls-card"
                    style={{
                        ...nodeCard(30, 150, 220, 240),
                        padding: 14,
                        display: 'flex',
                        flexDirection: 'column',
                        borderColor:
                            activePaths.has('E') || activePaths.has('F')
                                ? 'var(--orange-500)'
                                : 'var(--border)',
                        transition: 'border-color .3s',
                        boxShadow: activePaths.has('E')
                            ? 'var(--sh-glow)'
                            : 'var(--sh-sm)',
                    }}
                >
                    ...
                    >
                        <Icon name="sdk" size={12} /> MAACC SDK
                    </span>
                    <div style={{ marginTop: 12, display: 'grid', gap: 7 }}>
                        {[
                            ['database', 'Your database'],
                            ['cpu', 'Business logic'],
                            ['fingerprint', 'User permissions'],
                        ].map(([ic, t]) => (
                            <div
                                key={t}
                                style={{
                ...
                <div
                    className="ls-card ls-card-glow"
                    style={{
                        ...nodeCard(366, 90, 248, 360),
                        padding: 14,
                        display: 'flex',
                        flexDirection: 'column',
                        background: 'var(--surface)',
                        ...
                        {[
                            {
                                ic: 'agents',
                                t: 'Agent Runtime',
                                s: 'prompt · plan · resume',
                                tone: 'var(--primary)',
                                hot: activePaths.has('A'),
                            },
                            {
                                ic: 'llm',
                                t: 'LLM Gateway',
                                s: 'approved model routing',
                                tone: 'var(--teal-500)',
                                hot:
                                    activePaths.has('B') ||
                                    activePaths.has('C'),
                            ...
                            <div
                                ...
                                style={{
                                    ...
                                    background: r.hot
                                        ? 'var(--surface-3)'
                                        : 'var(--surface-2)',
                                    border: `1px solid ${r.hot ? r.tone : 'var(--border)'}`,
                                    transition:
                ...
                <div
                    className="ls-card"
                    style={{
                        ...nodeCard(730, 108, 216, 150),
                        padding: 13,
                        borderColor: activePaths.has('B')
                            ? 'var(--teal-500)'
                            : 'var(--border)',
                        transition: 'border-color .3s',
                    }}
                ...
                <div
                    className="ls-card"
                    style={{
                        ...nodeCard(730, 300, 216, 150),
                        padding: 13,
                        borderColor: activePaths.has('D')
                            ? 'var(--teal-500)'
                            : 'var(--border)',
                        transition: 'border-color .3s',
                    }}
                ...
                <FlowTag
                    x={308}
                    y={300}
                    on={activePaths.has('E')}
                    color="var(--orange-500)"
                    text="tool request · pause"
                />
                <FlowTag
                    x={308}
                    y={372}
                    on={activePaths.has('F')}
                    color="var(--teal-500)"
                    text="tool result · resume"
                />
                <FlowTag
                    x={672}
                    y={146}
                    on={activePaths.has('B')}
                    color="var(--teal-500)"
                    text="model call"
                />
            </div>
    ...
    const zones = [
        {
            ic: 'stack',
            t: 'Your Application',
            s: 'SDK · your DB · business logic · permissions',
            tone: 'var(--orange-500)',
        },
        {
            ic: 'agents',
            t: 'MAACC Control Plane',
            s: 'runtime · LLM gateway · tools · governance',
            tone: 'var(--primary)',
        },
        {
            ic: 'cpu',
            t: 'Model providers & hosted tools',
            s: 'Azure · Bedrock · Vertex · on-prem · search',
            tone: 'var(--teal-500)',
        },
    ];
    return (
...
function Architecture() {
    ...
    useEffect(() => {
        ...
        if (reduce) return;
        const t = setInterval(() => {
            if (!paused.current) setActive((a) => (a + 1) % FLOW_STEPS.length);
        }, 2800);
    ...
    return (
        ...
        >
            <div className="ls-wrap">
                <SectionHead
                    center
                    kicker="The orchestration story"
...
function Simulator() {
    ...
    const ANSWER =
        'Across 3 active voyages, 2 exceptions need attention: MV Al Rayyan is running 6h behind at Berth 4, and voyage V-2291 has a documentation gap. Fuel burn is within plan. Recommend reallocating Berth 7 to clear the backlog.';
    ...
    function play() {
        ...
        at(150, () => {
            ...
            pushEvent({
                ...
                tone: 'var(--primary)',
                title: 'Run accepted',
                detail: 'POST /api/agents/ag_ops_summary/runs',
                note: 'from Marine Operations Portal',
            });
        });
        at(850, () => {
            setStatus('running');
            ...
            pushEvent({
                ...
                detail: 'GPT-4o · Azure OpenAI',
                note: 'per project model policy',
            });
        });
        at(1650, () => {
            setProgress(32);
            pushEvent({
                ...
                note: 'Needs approved operational records to answer',
            });
        });
        at(2500, () => {
            setStatus('requires_tool');
            setProgress(45);
            pushEvent({
                icon: 'tools',
                tone: 'var(--orange-500)',
                title: 'Tool call requested',
                detail: 'getOperationalRecords({ from:"2026-01-01", to:"2026-03-31" })',
                note: 'execution mode: client-side',
            });
        });
        at(2900, () => {
            ...
            pushEvent({
                ...
                tone: 'var(--orange-400)',
                title: 'Run paused',
                note: 'Tool request returned to your SDK — MAACC holds the run',
            });
        });
        ...
        at(3350, () =>
            pushLog({
                tone: 'var(--text-2)',
                t: '◇ SDK received tool request',
            }),
        );
        at(3750, () =>
            pushLog({
                tone: 'var(--primary)',
                t: '▶ handler getOperationalRecords()',
            }),
        );
        at(4200, () =>
            pushLog({
                tone: 'var(--teal-500)',
                t: "✓ user.hasPermission('operations:view')",
            }),
        );
        at(4750, () =>
            pushLog({
                tone: 'var(--teal-500)',
                t: '✓ SELECT … FROM fleet.voyages → 97 rows',
            }),
        );
        at(5250, () =>
            pushLog({
                tone: 'var(--orange-500)',
                t: '↩ return summary  ·  256 KB',
            }),
        );
        ...
        at(5650, () => {
            ...
            pushEvent({
                ...
                detail: 'validated against output schema',
                note: 'raw rows stay in your app — only the summary returns',
            });
        });
        at(6150, () => {
            setProgress(84);
            pushEvent({
                ...
                tone: 'var(--primary)',
                title: 'Agent resumed',
                note: 'composing the final answer',
            });
        });
        ...
        let base = 6600;
        words.forEach((w, i) => {
            at(base + i * 55, () => setAnswer((a) => (a ? a + ' ' : '') + w));
        });
        ...
        at(end, () => {
            ...
            pushEvent({
                ...
                tone: 'var(--teal-500)',
                title: 'Run completed',
                detail: '1,380 tokens · $0.021 · 2.4s',
                note: 'traced & auditable in Runs & Audit Logs',
            });
        });
        at(end + 200, () => {
            setPlaying(false);
    ...
    return (
        ...
        >
            ...
            <div className="ls-wrap" style={{ position: 'relative' }}>
                <SectionHead
                    center
                    kicker="How it works · pause & resume"
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        Summarise today's fleet operations and
                                        flag any exceptions for the duty
                                        manager.
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    />{' '}
                                    Runs against your DB, with your permissions.
                                    MAACC never connects to it.
                                </div>
                            </div>
                            ...
                            >
                                ...
                                >
                                    <LogoMark size={16} /> MAACC run trace
                                </div>
                                <div
                                    ref={traceRef}
...
function tokenizeLine(line, lang) {
    ...
    while ((m = re.exec(line)) !== null) {
        if (m.index > last)
            out.push({ text: line.slice(last, m.index), cls: '' });
        const g = m.groups
            ? Object.keys(m.groups).find((k) => m.groups[k] != null)
            : null;
                            ...
                            {[
                                {
                                    n: '01',
                                    ic: 'key',
                                    t: 'Get project credentials',
                                    d: 'Register a project in MAACC and copy its environment credentials.',
                                },
                                {
                                    n: '02',
                                    ic: 'sdk',
                                    t: 'Install & register tools',
                                    d: 'Add the SDK and implement the client-side tool contracts you defined.',
                                },
                                {
                                    n: '03',
                                    ic: 'play',
                                    t: 'Invoke an agent',
                                    d: 'Call runAgent — pause, tool execution and resume are automatic.',
                                },
                            ].map((s) => (
                                <div
                                    key={s.n}
...
function tokenizeJson(line) {
    ...
    while ((m = re.exec(line)) !== null) {
        if (m.index > last)
            out.push({ text: line.slice(last, m.index), cls: 'tok-punc' });
        const cls = m[1]
            ? 'tok-prop'
            : m[2]
              ? 'tok-str'
    ...
    if (last < line.length)
        out.push({ text: line.slice(last), cls: 'tok-punc' });
    return out.length ? out : [{ text: line || ' ', cls: '' }];
}

function buildContract(s) {
    const props = s.params
        .map((p) => {
...
function buildStub(s) {
    const argComment = s.params
        .map((p) => `${p.name}${p.required ? '' : '?'}: ${baseType(p.type)}`)
        .join('  ·  ');
    if (s.lang === 'ts') {
        const call = s.params
            .map((p) => `      ${camel(p.name)}: args.${p.name},`)
            .join('\n');
  ...
  return { summary: result.summary, records: result.records };
    ...
    if (s.lang === 'py') {
        const call = s.params
            .map(
                (p) =>
                    `        ${p.name}=args${p.required ? `["${p.name}"]` : `.get("${p.name}")`},`,
            )
            .join('\n');
...
${call}
    ...
    const call = s.params
        .map(
            (p) =>
                `        '${p.name}' => $args['${p.name}']${p.required ? '' : ' ?? null'},`,
        )
        .join('\n');
    return `// contract "${s.name}" — implement it in your app
...
function StubGen() {
    ...
    const rmParam = (i) =>
        setParams((ps) => (ps.length <= 1 ? ps : ps.filter((_, j) => j !== i)));
    const copy = () => {
        try {
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            style={{
                                                ...
                                                cursor: 'pointer',
                                                fontFamily: 'var(--mono)',
                                                border: `1px solid ${p.required ? 'var(--primary)' : 'var(--border-2)'}`,
    ...
    return (
        ...
        >
            <div className="ls-wrap">
                ...
                >
                    Powering AI across internal platforms
                </div>
            </div>
            <div
                style={{
        ...
        >
            <div
                style={{
                    ...
                    inset: 0,
                    background:
                        'linear-gradient(180deg, var(--bg), var(--hero-3))',
                }}
            />
            <div className="ls-gridbg" style={{ opacity: 0.6 }} />
            <div className="ls-wrap" style={{ position: 'relative' }}>
                <div
                    style={{
                        display: 'grid',
                ...
                >
                    <span
                        ...
                        style={{ color: 'var(--text-3)' }}
                    >
                        <Icon name="info" size={13} /> Illustrative figures for
                        demonstration
                    </span>
                </Reveal>
            </div>
    ...
    const quotes = [
        {
            ...
            name: 'Reema Saleh',
            role: 'Staff Engineer · Marine Operations',
            tone: 'var(--teal-500)',
        },
        {
...
const TIERS = [
    {
        ...
        price: '$0',
        unit: 'free forever',
        blurb: 'For prototyping and evaluation.',
        cta: 'Start free',
        variant: 'ghost',
        href: '/register',
        tone: 'var(--teal-500)',
    ...
    },
    {
        ...
        price: '$0.02',
        unit: '/ agent run',
        note: '+ model tokens billed at provider cost',
        ...
        feats: [
            ...
            'Client-side tools & SDK',
            'RBAC, approvals & policies',
            '90-day audit logs & exports',
            'Email + Slack support',
        ],
    },
    {
        ...
        price: "Let's talk",
        unit: 'custom',
        blurb: 'For org-wide governance and scale.',
        cta: 'Contact sales',
        variant: 'ghost',
        href: '#onboarding',
        tone: 'var(--orange-500)',
    ...
    const steps = [
        {
            n: '01',
            ic: 'building',
            t: 'Register your application',
            d: 'Create a project in MAACC and get environment credentials for dev, staging and production.',
        },
        {
            n: '02',
            ic: 'sdk',
            t: 'Install the SDK & implement tools',
            d: 'Add the SDK, then implement the client-side tool contracts inside your own codebase.',
        },
        {
            n: '03',
            ic: 'send',
            t: 'Publish & invoke',
            d: "Test in the playground, publish your agent, and call it from your app. That's it.",
        },
    ];
    return (
        <section
        ...
        >
            <div className="ls-wrap">
                ...
                >
                    ...
                    <Btn href="#docs" variant="ghost" icon="book">
                        Browse the docs
                    </Btn>
                </Reveal>
            </div>
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    Bring every agent under{' '}
                    <span className="ls-grad">one control centre</span>
                </Reveal>
                <Reveal
                    as="p"
                    delay={2}
                    className="ls-sub"
                    style={{ margin: '18px auto 0', textAlign: 'center' }}
                >
                    Orchestrate models, tools and runs from a single platform —
                    with your data exactly where it belongs.
                </Reveal>
                <Reveal
                    as="div"
                    delay={3}
            ...
            <div className="ls-wrap">
                ...
                >
                    <div>
                        ...
                        >
                            The Multi AI Agent Control Centre — orchestrate
                            agents, models and tools from one governed platform.
                        </p>
                        <div
                            style={{
                                display: 'flex',
                        ...
                        >
                            <span
                                style={{
                                    ...
                                    boxShadow:
                                        '0 0 0 3px color-mix(in srgb, var(--teal-500) 22%, transparent)',
                                }}
                            />
                            <span
                                style={{
                ...
                >
                    <span style={{ fontSize: 12.5, color: 'var(--text-3)' }}>
                        © 2026 MAACC · Multi AI Agent Control Centre.
